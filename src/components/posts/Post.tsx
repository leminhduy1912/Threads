...
//   const getUser = async () => {
//     try {
//       const res = await clientRequest("/api/users/profile/" + post.postedBy);
...
//               <Link href={`/users/${encodeURIComponent("user-name")}`}>
//                 <UserAvatar avatarUrl="https://example.com/path-to-avatar.jpg" />
//               </Link>
//             </UserTooltip>
//             <div>
...
//         )} */}
//         {/* <Image width={100} height={150} src={"https://res-console.cloudinary.com/dolaccvrd/thumbnails/v1/image/upload/v1732359408/VGhyZWFkcy9lcG1nbWgwOXF6aGJwM240NG9ibg==/drilldown"} alt="" /> */}
//         <img src={post.img} alt="" />
//         {/* <MediaPreviews attachments={"https://th.bing.com/th/id/R.fc27814e13a42e2f73deb93ddb4cdaa4?rik=0fNlODUotgCcJw&pid=ImgRaw&r=0"} /> */}
